...
void setup() {
  ...
  g_Menu.addNode(3, meniuMiscaAxa1_5pasi, MeniuMisca5Pasi);
  g_Menu.addNode(4, meniuPozitieAxa1, MeniuPozAxa1);
  g_Menu.addNode(3, meniuMiscaAxa1_10pasi, MeniuMisca10Pasi);
  g_Menu.addNode(4, meniuPozitieAxa1, MeniuPozAxa1);

  g_Menu.addNode(2, meniuMiscaAxa2, MeniuAxa2);
  g_Menu.addNode(3, meniuMiscaAxa2_5pasi, MeniuMisca5Pasi);
